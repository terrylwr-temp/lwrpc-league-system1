...
- Mobile header: show a hamburger menu and the club logo at left, the active dashboard name and a clearly readable active team name centered, and compact actions at right. Keep this entire identity/action row sticky at the top while dashboard content scrolls; the hamburger opens the complete dashboard navigation, including League Documents and My Play History. Play History replaces My Team as a direct bottom-navigation choice on Player and Captain dashboards.
