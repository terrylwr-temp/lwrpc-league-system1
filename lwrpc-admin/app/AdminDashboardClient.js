  ...
  useEffect(() => {
    async function run() {
      ...
      if (user) {
        ...
        setCurrentAdminMember(
          adminMember || {
            id: user.memberId || authUser?.id || "",
    ...
    return (
      ...
      <AdminDesignPreviewView
        dashboard={{
          ...
          messagesPanel: dashboardMessagesPanel,
          resetPanel: resetOptionsPanel,
          resetHelpPanel: seasonResetHelpPanel,
          analyticsPanel: (
            <ExecutiveDashboard
