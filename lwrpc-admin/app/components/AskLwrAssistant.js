...
function AssistantContent({ role = "player", inputRef, closeButtonRef, onClose, drawer = false }) {
  ...
  return <>
    ...
    <div className={bodyClass}>
      <p className="shrink-0 px-1 text-center text-xs leading-4 text-slate-500">Ask LWR PC AI may make mistakes. Check Official Sources for important information.</p>
