...
const PBCC_HEAD_ELEMENTS = [
  { id: "pbcc-pwa-manifest", tag: "link", attrs: { rel: "manifest", href: "/pbcc-manifest.webmanifest" } },
  ...
  { id: "pbcc-pwa-apple-icon", tag: "link", attrs: { rel: "apple-touch-icon", href: "/pbcc-icon-192.png" } },
];
...
export default function PbccPwaRegister() {
  useEffect(() => {
    ...
    if ("serviceWorker" in navigator) {
      navigator.serviceWorker.register("/pbcc-sw.js", { scope: "/pbcc/" }).catch(console.error);
    }
