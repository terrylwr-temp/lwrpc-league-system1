...
const PBCC_PWA_VERSION = "pbcc-header-pickleball-transparent-20260621";
...
const PBCC_HEAD_ELEMENTS = [
  ...
  { id: "pbcc-pwa-apple-icon", tag: "link", attrs: { rel: "apple-touch-icon", href: `/pbcc-header-pickleball-transparent-icon-192.png?v=${PBCC_PWA_VERSION}` } },
];
