        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-slate-950/70 p-3 sm:items-center sm:p-4">
          <div className="w-full max-w-md overflow-hidden rounded-lg bg-white shadow-[0_28px_80px_-36px_rgba(15,23,42,0.95)]">
            <div className="bg-[linear-gradient(135deg,#1d4ed8,#0f766e)] p-4 text-white">
              ...
              <h2 className="mt-1 text-xl font-black">LWR PB Club System</h2>
            </div>
            <div className="p-4">
              <div className="flex items-center gap-3 rounded-lg border border-blue-100 bg-blue-50 p-3">
                <Image src="/lms-icon-192.png" alt="" width={48} height={48} className="h-12 w-12 rounded-xl bg-white object-contain shadow-sm" />
                <p className="text-sm font-bold leading-relaxed text-blue-950">{deviceInstallSteps()}</p>
              </div>
              <button
                type="button"
