...
export default function CaptainDesignPreviewView({ dashboard = {} }) {
  ...
  return (
    <main className={["full-screen-main", styles.page, captainStyles.captainPage, appearance.isLightCardHeaders ? styles.lightCardHeaders : ""].filter(Boolean).join(" ")} id="captain-preview-dashboard">
