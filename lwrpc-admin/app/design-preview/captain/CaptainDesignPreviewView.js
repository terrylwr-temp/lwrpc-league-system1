  ...
  function renderMatchToolActions(match) {
    ...
    return (
      <div className={captainStyles.matchToolsActions}>
        <button type="button" className={captainStyles.blueAction} onClick={() => { setMatchToolsMatch(null); dashboard.onOpenMatch?.(match); }}>View Match</button>
