...
const ADMIN_SECTIONS = [
  {
    ...
    cards: [
      ...
      { title: "Division Standings", desc: "Review every current division's standings.", path: "/division-standings", code: "DS", tone: "blue", role: "league_manager" },
      { title: "Division Schedules", desc: "Review team schedules for any current division.", path: "/division-schedules", code: "SC", tone: "amber", role: "league_manager" },
    ],
  },
  {
    key: "matches",
  ...
  },
  {
    ...
    cards: [
      ...
      { title: "AI Assistant Management", desc: "Manage official AI rule sources and inspect PDF processing.", path: "/ai-assistant", exact: true, code: "AI", tone: "emerald", role: "league_manager" },
      { title: "Test AI Assistant", desc: "Test grounded official-document answers with retrieval diagnostics.", path: "/ai-assistant/console", exact: true, code: "AT", tone: "blue", role: "league_manager" },
      { title: "AI Feedback & Review", desc: "Review answer feedback, unanswered questions and manager decisions.", path: "/ai-assistant/review", exact: true, code: "AR", tone: "amber", role: "league_manager" },
