...
const benchmark=JSON.parse(fs.readFileSync('../docs/lms-0722-production-benchmark.json'));
...
fs.writeFileSync('../docs/lms-0722-production-metrics.json',JSON.stringify(report,null,2));
...
fs.writeFileSync('../docs/lms-0722-production-benchmark.md',lines.join('\n')+'\n');console.log(JSON.stringify(report,null,2));
