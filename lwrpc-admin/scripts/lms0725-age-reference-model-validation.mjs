...
const phase=process.argv.includes('--age-only')?'age':'full';
const outputPath=new URL(`../../docs/lms-0725-age-reference-${phase}${only?'-'+only:''}-${provider?'model-results':'preflight'}.json`,import.meta.url);
