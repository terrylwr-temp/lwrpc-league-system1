...
const root=process.cwd(),dir=path.join(root,'..','.local-validation','lms0729-browser-fixture-'+Date.now());fs.mkdirSync(dir,{recursive:true});
...
const child=spawn(process.execPath,[path.join(root,'node_modules/next/dist/bin/next'),'dev','--webpack','--port','3086'],{cwd:dir,env,stdio:'inherit',windowsHide:true});
