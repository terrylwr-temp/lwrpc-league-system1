const CACHE_NAME = "pbcc-pwa-static-v8";
const STATIC_CACHE_PREFIX = "pbcc-pwa-static-";
const PRECACHE_URLS = [
  "/pbcc-manifest.webmanifest",
  "/pbcc-header-pickleball-transparent-icon-192.png",
  "/pbcc-header-pickleball-transparent-icon-512.png",
  "/favicon.ico",
];
...
self.addEventListener("push", (event) => {
  ...
  const options = {
    ...
    icon: payload.icon || "/pbcc-header-pickleball-transparent-icon-192.png",
    badge: payload.badge || "/pbcc-header-pickleball-transparent-icon-192.png",
