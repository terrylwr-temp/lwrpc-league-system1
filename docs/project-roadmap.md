...
- Ratings Import now explains its CSV fields and preservation behavior in a Continue/Cancel dialog before the file picker opens. CSV imports only fill blank DUPR Doubles values, preserving existing ones; Delete Season Ratings remains the intentional way to clear a season and import anew. The visible app version was bumped to `LMS-0654`.
