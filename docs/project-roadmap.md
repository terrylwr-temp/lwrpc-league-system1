...
- Root layout includes a pre-hydration cleanup script for browser-extension injected `fdprocessedid` attributes on form controls, preventing noisy React hydration mismatch warnings without changing app-rendered markup.
